Zylab 12.7 takes the user input and outputs their fat burning heart rate. It raises a value error if the user inputs an age that is not between 18 and 75.
